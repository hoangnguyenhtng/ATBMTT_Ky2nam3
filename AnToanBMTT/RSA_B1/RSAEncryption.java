...
public class RSAEncryption {
    public static void main(String[] args) {
        try {
            ...
            BufferedReader reader = new BufferedReader(new FileReader("D:\\AnToanVaBaoMatThongTin-Ky2Nam3\\AnToanBaoMatThongTin\\ATBMTT-Java\\AnToanBMTT\\RSA_B1\\input.txt"));
            ...
            BufferedWriter writer = new BufferedWriter(new FileWriter("D:\\AnToanVaBaoMatThongTin-Ky2Nam3\\AnToanBaoMatThongTin\\ATBMTT-Java\\AnToanBMTT\\RSA_B1\\output.txt"));
            ...
            writer.write("e) Việc mã hóa ở câu c) thực hiện nhiệm vụ chữ ký số.\n");
            writer.close();
